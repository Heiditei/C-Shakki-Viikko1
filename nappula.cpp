...
void Sotilas::annaSiirrot(std::list<Siirto>& lista, Ruutu* ruutu, Asema* asema, int vari)
{
	...
	if ((lahtoruutuY == 1 || lahtoruutuY == 2 || lahtoruutuY == 3 || lahtoruutuY == 4 || lahtoruutuY == 5 || lahtoruutuY == 6) && lahtoruudunNappulanVari == 0) {
		//siirtym‰t eteenp‰in
		if (asema->_lauta[lahtoruutuX][lahtoruutuY + 1] == NULL) {
			if (lahtoruutuY == 6)
	...
	if ((lahtoruutuY == 6 || lahtoruutuY == 5 || lahtoruutuY == 4 || lahtoruutuY == 3 || lahtoruutuY == 2 || lahtoruutuY == 1) && lahtoruudunNappulanVari == 1) {
		//siirtym‰t eteenp‰in
		if (asema->_lauta[lahtoruutuX][lahtoruutuY - 1] == NULL) {
			if (lahtoruutuY == 1)
				lisaaSotilaanKorotukset(&Siirto(*ruutu, Ruutu(lahtoruutuX, lahtoruutuY - 1)), lista, asema);
